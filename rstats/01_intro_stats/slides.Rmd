...
```{r, echo = FALSE, dev.args = list(bg = 'transparent'), fig.asp = 3/4, fig.align = 'center', echo = FALSE, out.width = "70%", dpi= 300}
...
```{r, echo = FALSE, dev.args = list(bg = 'transparent'), fig.asp = 2/4, fig.align = 'center', echo = FALSE, out.width = "40%", dpi= 300}
ggplot() +
...
```{r, echo = FALSE, dev.args = list(bg = 'transparent'), fig.align = 'center', echo = FALSE, out.width = "50%", dpi= 300, message = FALSE, warning = FALSE}
